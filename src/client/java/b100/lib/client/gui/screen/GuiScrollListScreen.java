package b100.lib.client.gui.screen;

import b100.lib.client.gui.element.GuiElement;
import b100.lib.client.gui.element.GuiScrollBar;
import b100.lib.client.gui.element.GuiScrollableList;
import b100.lib.client.gui.element.GuiScrollableList.Layout;
...
public abstract class GuiScrollListScreen extends GuiScreen {
	...
	public void onResize() {
		...
		scrollBar.setPosition(scrollList.posX + scrollList.width / 2 + contentWidth / 2 + 16, scrollList.posY + GuiScrollableList.SEPERATOR_SIZE).setSize(scrollBarWidth, scrollList.height - 2 * GuiScrollableList.SEPERATOR_SIZE);
		super.onResize();
	}
