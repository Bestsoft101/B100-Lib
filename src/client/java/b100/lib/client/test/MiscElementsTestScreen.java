...
class MiscElementsTestScreen extends BasicScrollableScreen {
	...
	public void initScrollElements() {
		GuiButton button1 = scrollList.add(new GuiButton(this, Component.nullToEmpty("Clickable button")));
		button1.setClickable(true);
		
		GuiButton button2 = scrollList.add(new GuiButton(this, Component.nullToEmpty("Not clickable button")));
		...
		GuiTextField textField1 = scrollList.add(new GuiTextField(this, Component.nullToEmpty("Text field 1")));
		...
		GuiTextField textField2 = scrollList.add(new GuiTextField(this, Component.nullToEmpty("Text field 2")));
		textField2.setText("Not editable text field");
		textField2.setEditable(false);
		textField2.setFocusable(true);
		
		GuiTextField textField3 = scrollList.add(new GuiTextField(this, Component.nullToEmpty("Text field 3")));
